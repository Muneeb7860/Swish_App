...
export default function App() {
  ...
  const [products, setProducts] = useState([
    { id: 'p1', name: 'Fresh Milk', price: 3.49, stock: 12, stockEast: 15, category: 'Dairy & Eggs', emoji: '🥛', perishable: true },
    { id: 'p2', name: 'Bananas', price: 1.99, stock: 18, stockEast: 20, category: 'Fruits & Veggies', emoji: '🍌', perishable: false }
  ]);
