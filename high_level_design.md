...
*   [README.md](./README.md) — Project landing page and branch workflow summary.
*   [docs/ARCHITECTURE.md](./docs/ARCHITECTURE.md) — System tech stack and deployment architecture blueprint.
*   [docs/BRD.md](./docs/BRD.md) — Business requirements, KPIs, and B2B SaaS monetization objectives.
*   [docs/HLD.md](./docs/HLD.md) — Intermediate context diagrams and container descriptions.
*   [docs/LLD.md](./docs/LLD.md) — Low-Level implementation guidelines and configuration snippets.
