...
*   **Vector Search Grounding (RAG - Phase 6)**: Connect the Letta core memory blocks or FastAPI pipeline to PostgreSQL pgvector tables to retrieve and inject SwissQ commerce product catalogs automatically based on user query context.
