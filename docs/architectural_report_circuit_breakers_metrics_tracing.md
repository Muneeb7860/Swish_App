...
- **Location**: [memory_mesh.py](../homelab-ai-governance/src/governance/stubs/memory_mesh.py)
...
- **Location**: [LettaMemoryService.java](../backend/src/main/java/ch/swissqcommerce/backend/domain/agent/core/service/LettaMemoryService.java)
...
- **Locations**:
  ...
  - [GeminiFreeAdapter.java](../backend/src/main/java/ch/swissqcommerce/backend/domain/agent/adapter/out/gemini/GeminiFreeAdapter.java)
