...
- [x] **Task 1: Create Resilient Gateway Adapter**
  - [x] Create [ResilientLlmGateway.java](../../backend/src/main/java/ch/swissqcommerce/backend/domain/agent/adapter/out/resilient/ResilientLlmGateway.java) implementing `LlmGatewayPort`.
...
- [x] **Task 5: Update Unit and Integration Test Suites**
  ...
  - [x] Create [ResilientLlmGatewayTest.java](../../backend/src/test/java/ch/swissqcommerce/backend/domain/agent/adapter/out/resilient/ResilientLlmGatewayTest.java) to thoroughly test PII detection, routing paths, and fail-safe blocking.
