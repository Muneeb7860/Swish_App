		...
		<SafeAreaView style={styles.container}>
			...
			<View style={styles.topSelector}>
				<TouchableOpacity
					style={[
						styles.selectorBtn,
						activeCockpit === "customer" && styles.selectorBtnActiveCustomer,
					]}
				...
				>
					<Text
						style={[
							styles.selectorText,
							activeCockpit === "customer" && styles.selectorTextActiveCustomer,
						]}
					>
						🛍️ CUSTOMER
					</Text>
				...
				<TouchableOpacity
					style={[
						styles.selectorBtn,
						activeCockpit === "rider" && styles.selectorBtnActiveRider,
					]}
				...
				>
					<Text
						style={[
							styles.selectorText,
							activeCockpit === "rider" && styles.selectorTextActiveRider,
						]}
					>
						🏍️ RIDER
					</Text>
				...
				<TouchableOpacity
					style={[
						styles.selectorBtn,
						activeCockpit === "picker" && styles.selectorBtnActivePicker,
					]}
				...
				>
					<Text
						style={[
							styles.selectorText,
							activeCockpit === "picker" && styles.selectorTextActivePicker,
						]}
					>
						📦 PICKER
					</Text>
