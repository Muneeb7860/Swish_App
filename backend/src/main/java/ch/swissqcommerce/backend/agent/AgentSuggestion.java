...
/**
 * Structured output from every agent. This is the contract between the Agent Layer and the Policy
 * Engine. Agents produce these; they never write to the database.
 *
