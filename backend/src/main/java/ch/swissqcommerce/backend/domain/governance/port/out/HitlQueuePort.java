...
/**
 * Outbound port giving the governance core read/resolve access to the agent-escalation {@code
 * HitlQueue} table (Phase 8 queue unification), without the core depending on the JPA repository
 * directly (ADR-001).
 */
