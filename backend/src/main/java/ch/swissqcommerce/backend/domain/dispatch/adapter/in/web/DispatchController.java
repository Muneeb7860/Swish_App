...
public class DispatchController {
    ...
    public ResponseEntity<GearScan> submitGearScan(@RequestBody GearScanRequest request) {
        GearScan scan = dispatchUseCase.submitGearScan(
                request.getRiderId(),
                request.getGearType(),
    ...
    public ResponseEntity<ActiveShipment> updateRiderGps(@RequestBody GpsPingRequest request) {
        ActiveShipment shipment = dispatchUseCase.updateRiderGps(
                request.getRiderId(),
                request.getLatitude(),
    ...
    public ResponseEntity<ActiveShipment> updateStatus(@RequestBody StatusUpdateRequest request) {
        ActiveShipment shipment = dispatchUseCase.updateShipmentStatus(
                request.getOrderId(),
                request.getStatus()
        );
        return ResponseEntity.ok(shipment);
