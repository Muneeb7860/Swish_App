...
public class PaymentConfig {
    ...
    @Bean
    public PaymentProcessingUseCase paymentProcessingUseCase(TransactionRepositoryPort transactionRepositoryPort,
    ...
    public PaymentUseCase paymentUseCase(PaymentPort paymentPort,
        ...
        return new PaymentUseCaseImpl(paymentPort, orderPort, ledgerUseCase, outboxEventPort, eventPublisher);
    }
}
