...
public class FmcgCatalogServiceImpl implements FmcgCatalogUseCase {
    ...
    public List<FmcgImportResult> importFmcgProducts() {
        return importFmcgProducts(false, 1.2, 0.20);
    }
    ...
    public List<FmcgImportResult> importFmcgProducts(
        ...
        boolean raining = isRaining != null ? isRaining : false;
        double ratio = riderToOrderRatio != null ? riderToOrderRatio : 1.2;
        double density = vipDensity != null ? vipDensity : 0.20;
            ...
            try {
                DynamicPricingAgent.PricingAnalysis analysis =
                        dynamicPricingAgent.recommendPricing(
                                raining, ratio, competitorPriceVal, perishable ? 2 : 45, density);
                if (analysis != null) {
