...
@Tag(
        name = "Inventory & Picker",
        description = "Picker queue management, order handover, and stock rebalancing")
public class PickerController {
    ...
    @Operation(
            summary = "List picker queue",
            description =
                    "Returns all pickers currently active and available for order picking in a"
                            + " given store.")
    ...
    @Operation(
            summary = "Picker handover to rider",
            description =
                    "Records that a picker has completed picking and handed the packed order to the"
                            + " assigned rider.")
    @PreAuthorize("hasAnyRole('PICKER','ADMIN')")
    ...
    @Operation(
            summary = "Trigger stock rebalancing",
            description =
                    "Initiates a transfer of SKU stock between dark-store locations to prevent"
                            + " stockouts.")
    @PreAuthorize("hasAnyRole('PICKER','ADMIN')")
