...
public interface WholesalerUseCase {
    ...
    B2BRestockOrder createRestockOrder(
    ...
    ch.swissqcommerce.backend.domain.wholesaler.core.model.PurchaseOrder
            generateReplenishmentOrders(
                    String storeId, String vendorName, Map<String, Integer> requestedItems);

    ch.swissqcommerce.backend.domain.wholesaler.core.model.PurchaseOrder receiveGoods(
            String poId, Map<String, Integer> itemReceipts, String grnFileUrl);

    ch.swissqcommerce.backend.domain.wholesaler.core.model.WastageLog logWastage(
            String storeId,
            String productId,
            String batchId,
            Integer qty,
