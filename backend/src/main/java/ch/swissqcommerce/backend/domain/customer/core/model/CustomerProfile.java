...
public class CustomerProfile {
    ...
    public CustomerProfile(String profileId, String userId, Preferences prefs, List<DeliveryAddress> addressBook) {
    ...
    public List<DeliveryAddress> getAddressBook() { return addressBook; }
    public void setAddressBook(List<DeliveryAddress> addressBook) { this.addressBook = addressBook; }
    ...
    public static class Builder {
        ...
        public Builder prefs(Preferences prefs) { this.prefs = prefs; return this; }
        public Builder addressBook(List<DeliveryAddress> addressBook) { this.addressBook = addressBook; return this; }
