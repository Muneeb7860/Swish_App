...
/**
 * REST controller for Admin operations. Handles chaos fault injection/resolution, onboarding gate
 * approvals, HITL queue management, and system health monitoring.
 */
@RestController
...
@Tag(
        name = "Admin",
        description = "Chaos engineering, onboarding gate, HITL queue, and system health")
public class AdminController {
    ...
    public ResponseEntity<ChaosFaultLog> injectFault(
            @Valid @RequestBody InjectFaultRequest request) {
        ChaosFaultLog fault =
                adminService.injectFault(request.getFaultType(), request.getDetails());
    ...
    public ResponseEntity<Map<String, Object>> approveOnboarding(
            @PathVariable String appId, @Valid @RequestBody OnboardingApprovalRequest request) {
    ...
    public ResponseEntity<Map<String, Object>> resolveHitlTicket(
            @PathVariable String ticketId, @Valid @RequestBody HitlDecisionRequest request) {
        Map<String, Object> result =
                adminService.resolveHitlTicket(
