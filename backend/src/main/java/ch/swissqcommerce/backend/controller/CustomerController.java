...
/**
 * @deprecated Superseded by {@link ch.swissqcommerce.backend.domain.customer.adapter.in.web.CustomerController}.
 * Deactivated (no @RestController) to avoid duplicate URL mapping conflicts.
 * Kept as a reference stub — do not delete until domain controller provides full parity.
 */
