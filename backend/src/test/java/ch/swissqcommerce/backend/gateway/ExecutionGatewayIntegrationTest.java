...
public class ExecutionGatewayIntegrationTest {
    ...
    @Autowired private AgentSuggestionEntityRepository agentSuggestionRepo;

    @Autowired private PolicyDecisionRepository policyDecisionRepo;

    @Autowired private ExecutionRecordRepository executionRecordRepo;
    ...
    @Autowired private DarkStoreRepository darkStoreRepo;
    ...
    public void testExecute_HoldOrder_Success() throws Exception {
        ...
        AgentSuggestionEntity updatedSuggestion =
                agentSuggestionRepo.findById(suggestionId).orElseThrow();
