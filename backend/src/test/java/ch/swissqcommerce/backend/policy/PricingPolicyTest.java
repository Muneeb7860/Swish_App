...
public class PricingPolicyTest {
    ...
    public void testEvaluate_AutoApproved() {
        String recommendationJson = "{\"action\":\"update_price\",\"old_value\":100.0,\"new_value\":104.5}";
    ...
    public void testEvaluate_NeedsHuman_HighChange() {
        String recommendationJson = "{\"action\":\"update_price\",\"old_value\":100.0,\"new_value\":106.0}";
        AgentSuggestionEntity suggestion = AgentSuggestionEntity.builder()
                .id(UUID.randomUUID())
                .domain("pricing")
                .recommendation(recommendationJson)
    ...
    public void testEvaluate_NeedsHuman_LowConfidence() {
        String recommendationJson = "{\"action\":\"update_price\",\"old_value\":100.0,\"new_value\":104.0}";
        AgentSuggestionEntity suggestion = AgentSuggestionEntity.builder()
                .id(UUID.randomUUID())
                .domain("pricing")
                .recommendation(recommendationJson)
