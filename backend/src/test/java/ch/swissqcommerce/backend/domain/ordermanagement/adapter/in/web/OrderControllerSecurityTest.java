 ...
 *
 * <p>Guards against the IDOR where a caller could open an order saga on another customer's behalf
 * by passing an arbitrary {@code customerId} query parameter.
 *
...
class OrderControllerSecurityTest {
    ...
    @MockBean private OrderManagementUseCase orderUseCase;
