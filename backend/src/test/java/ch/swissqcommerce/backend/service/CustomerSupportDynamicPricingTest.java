...
public class CustomerSupportDynamicPricingTest {
    ...
    @BeforeEach
    public void setUp() {
        agentBudgetTracker = new AgentBudgetTracker(mock(io.micrometer.core.instrument.MeterRegistry.class));
        customerSupportAgent = new CustomerSupportAgent(llmGateway, lettaMemoryService, agentBudgetTracker);
