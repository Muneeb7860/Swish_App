...
public class OutboxEncryptionTest {
    ...
    public void testOutboxEventPayloadEncryptionAndDecryption() {
        ...
        String originalPayload =
                "{\"secret_key\": \"super-secret-123\", \"user_email\": \"customer@example.com\"}";
        ...
        String rawDbValue =
                (String)
                        entityManager
                                ...
                                .setParameter("id", savedEvent.getId())
                                .getSingleResult();

        // Assert that the raw value stored in the database is encrypted (not equal to original
        // plaintext)
        ...
        OutboxEvent retrievedEvent =
                outboxEventRepository.findById(savedEvent.getId()).orElse(null);
