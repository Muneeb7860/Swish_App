...
public class DispatchServiceImplTest {
    ...
    @Mock private DispatchPort dispatchPort;

    @Mock private EnrollmentOutPort enrollmentOutPort;
    ...
    public void testUpdateRiderGps() {
        ...
        when(dispatchPort.findActiveShipmentsByRiderAndStatus("RIDER-1", "ASSIGNED"))
                .thenReturn(List.of(shipment));
        when(dispatchPort.saveActiveShipment(any(ActiveShipment.class)))
                .thenAnswer(i -> i.getArguments()[0]);

        ActiveShipment updated =
                dispatchService.updateRiderGps(
    ...
    public void testRunReallocationAudit() {
        ...
        when(dispatchPort.findActiveShipmentsByStatusIn(anyList()))
                .thenReturn(List.of(oldShipment));
