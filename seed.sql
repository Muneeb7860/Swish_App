...
('item-7', 'store-2', 'Lindt Dark Chocolate Bar', 3.20, 250, 'Sweets', '🍫', false, 0),
  ('brand-7622210416681', 'store-1', 'Heudebert Biscottes', 4.92, 70, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7622210713803', 'store-1', 'Belvita Petit Déjeuner Chocolat', 4.17, 65, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7622210713902', 'store-1', 'Belvita Belvita original  - Biscuits petit déjeuner miel & pépites de chocolat', 5.37, 74, 'Snacks & Drinks', '📦', false, 0),
  ('brand-3017760819121', 'store-1', 'LU Chamonix', 4.59, 73, 'Snacks & Drinks', '📦', false, 0),
  ('brand-6111031005576', 'store-1', 'Oreo original  oreo', 2.17, 21, 'Snacks & Drinks', '📦', false, 0),
  ('brand-3392460460409', 'store-1', 'Heudebert Crackers heudebert', 1.81, 26, 'Snacks & Drinks', '📦', false, 0),
  ('brand-3045140118502', 'store-1', 'Milka Milka Tablette Noisette', 5.19, 53, 'Grocery & Kitchen', '🥛', false, 0),
  ('brand-7622201695323', 'store-1', 'Mondelez Halls', 1.76, 42, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7622202028199', 'store-1', 'Glico Mikado', 6.25, 38, 'Snacks & Drinks', '📦', false, 0),
  ('brand-5410041161700', 'store-1', 'Lu Grany moelleux, fruit des bois', 7.56, 58, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7622201515492', 'store-1', 'Milka Milka aux noisettes', 3.86, 30, 'Grocery & Kitchen', '🥛', false, 0),
  ('brand-7622210726223', 'store-1', 'Belvita Belvita petit déjeuner', 7.35, 16, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7622210438294', 'store-1', 'Côté d''Or L''Original noir', 8.49, 16, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7622202024115', 'store-1', 'Belin Crackers minizza tomate BELIN', 3.83, 57, 'Snacks & Drinks', '📦', false, 0),
  ('brand-3017760268196', 'store-1', 'Mondelez Feuilleté doré Collection LU', 3.36, 40, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7622202225512', 'store-1', 'Cadbury Original Oreo', 8.98, 63, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7622202334009', 'store-1', 'Cadbury dairy milk', 1.59, 42, 'Grocery & Kitchen', '🥛', false, 0),
  ('brand-09141209', 'store-1', 'Cadbury Bourn Vita 500Gram Pauch', 5.91, 59, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7622210882974', 'store-1', 'Cadbury Mini Eggs', 8.6, 34, 'Grocery & Kitchen', '📦', false, 0),
  ('brand-7622202219214', 'store-1', 'Cadbury Brunch Choc Chip', 8.28, 69, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7622202216695', 'store-1', 'Cadbury Gems', 5.1, 32, 'Snacks & Drinks', '📦', false, 0),
  ('brand-5034660021537', 'store-1', 'Cadbury Cadbury hot chocolate', 4.1, 22, 'Snacks & Drinks', '🍫', false, 0),
  ('brand-12111202', 'store-1', 'Cadbury Minis Mix Eggs', 5.3, 36, 'Grocery & Kitchen', '📦', false, 0),
  ('brand-7622202219306', 'store-1', 'Cadbury Brunch Bar', 8.94, 26, 'Snacks & Drinks', '🍫', false, 0),
  ('brand-7622201734862', 'store-1', 'Cadbury Roses chocolate box', 7.58, 59, 'Snacks & Drinks', '🍫', false, 0),
  ('brand-7622202325960', 'store-1', 'Cadbury Bournville Intense 70% Dark', 5.86, 12, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7622202318078', 'store-1', 'Cadbury 5 Star Chocolate Bar', 4.81, 51, 'Snacks & Drinks', '🍫', false, 0),
  ('brand-5000183501108', 'store-1', 'Cadbury Milk Chocolate spread', 8.26, 40, 'Grocery & Kitchen', '🍫', false, 0),
  ('brand-9300617065920', 'store-1', 'Cadbury OLD GOLD DARK CHOCOLATE', 7.57, 51, 'Snacks & Drinks', '🍫', false, 0),
  ('brand-7622202272639', 'store-1', 'Cadbury Cadbury Dairy Milk', 7.24, 34, 'Grocery & Kitchen', '🥛', false, 0),
  ('brand-3387390123210', 'store-1', 'Nestlé Chocapic', 6.78, 73, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7613036669146', 'store-1', 'Nestlé NESTLE CHOCAPIC BIO Céréales - Boite de 375g', 6.21, 61, 'Snacks & Drinks', '📦', false, 0),
  ('brand-3033710073467', 'store-1', 'Nestlé Chicorée & Café, RICORÉ® L''Original, Boîte de 100g', 2.02, 65, 'Snacks & Drinks', '📦', false, 0),
  ('brand-8002270014901', 'store-1', 'Nestlé S. Pellegrino Water', 7.43, 52, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7613035040823', 'store-1', 'Nestlé Nestlé dessert Noir', 3.66, 25, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7613035676497', 'store-1', 'Nestlé Chicorée & Café, RICORÉ® L''Original, Boîte de 260g', 5.87, 31, 'Snacks & Drinks', '📦', false, 0),
  ('brand-3033710084913', 'store-1', 'Maggi Arôme MAGGI - Bouteille 250g', 5.76, 58, 'Snacks & Drinks', '📦', false, 0),
  ('brand-8445290133403', 'store-1', 'Nestlé Nesquik', 3.53, 48, 'Snacks & Drinks', '📦', false, 0),
  ('brand-3033710065783', 'store-1', 'Nestlé Le Choco', 8.73, 42, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7613035449626', 'store-1', 'Nestlé NESTLE CHOCAPIC Céréales 645g', 8.27, 49, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7613032655495', 'store-1', 'Nestlé Chicorée & Café, RICORÉ® L''Original, Boîte de 260g', 3.64, 35, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7613287431943', 'store-1', 'Nestlé Nesquik Cocoa', 4.97, 46, 'Snacks & Drinks', '🍫', false, 0),
  ('brand-7613035530799', 'store-1', 'Nestlé NESQUIK Moins de Sucres', 8.58, 23, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7613287514325', 'store-1', 'Nestlé Fitness Nature Céréales complètes', 8.47, 52, 'Snacks & Drinks', '📦', false, 0),
  ('brand-7613032779566', 'store-1', 'Nestlé chocapic', 1.56, 42, 'Snacks & Drinks', '📦', false, 0);
